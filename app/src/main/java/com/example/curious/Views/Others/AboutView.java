...
public class AboutView extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public void findXmlElements(){
        ...
        // Toolbar
        toolbar = (androidx.appcompat.widget.Toolbar) findViewById(R.id.about_toolbar);
    ...
    public void setToolbar(){
        ...
        activityTitle.setText(R.string.txt_about);
    }
    ...
    public void initializeUI(){
        ...
        userNavigationView.getMenu().getItem(4).setChecked(true);
